...
describe('MainMenu', () => {
  ...
  it('renders the description text', () => {
    render(<MainMenu />);
    expect(screen.getByText('Classic Snake game built with Next.js and TypeScript')).toBeDefined();
  });
  ...
  it('renders the controls instruction text', () => {
    render(<MainMenu />);
    expect(screen.getByText('Use arrow keys to control the snake')).toBeDefined();
  });
